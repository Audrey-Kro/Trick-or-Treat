...
class Menu(simpleGE.Scene):
    def __init__(self):
        ...
        self.btnStart.center = (320, 200)

        self.btnQuit = simpleGE.Button()
        self.btnQuit.text = "Quit"
        self.btnQuit.center = (320, 300)

        self.sprites = [self.lblTitle, self.btnStart, self.btnQuit]
...
class Instructions(simpleGE.Scene):
    def __init__(self):
        ...
        self.btnBegin.center = (320, 190)
        self.btnBegin.bgColor = "orange"  # Set the background color to orange

        self.sprites = [self.lblInstructions, self.btnBegin]
...
class Game(simpleGE.Scene):
    def __init__(self):
        ...
        self.sprites = [self.lblScore, self.lblTimer, self.ghost] + self.chocolates + self.gumballs + self.broccolis
...
class GameOver(simpleGE.Scene):
    def __init__(self):
        ...
        self.sprites = [self.lblScore, self.btnQuit, self.btnAgain]
